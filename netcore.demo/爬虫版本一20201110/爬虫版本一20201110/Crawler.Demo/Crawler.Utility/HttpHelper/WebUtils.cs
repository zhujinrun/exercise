...
namespace Crawler.Utility.HttpHelper
{
    public class WebUtils
    {
        ...
        public string DoPost(string url, IDictionary<string, string> parameters,string contentType, string jsonStr="", bool gZip=false,IDictionary<string,string> headers =null)
        {
